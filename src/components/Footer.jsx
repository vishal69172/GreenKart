    ...
    <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-primaryLight">Company</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold mb-6 text-primaryLight">Quick Links</h3>
          ...
          <div>
            <h3 className="text-2xl font-bold mb-6 text-primaryLight">Follow us</h3>
